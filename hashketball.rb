...
def team_colors team_name
  team_data = game_hash.find{|location, team_info| team_info[:team_name] == team_name}
  team_data[1][:colors]
end
...
def player_numbers team_name
  team_data = game_hash.find{|location, team_info| team_info[:team_name] == team_name}
  team_data[1][:players].map{|player_hash| player_hash[:number]}
end
